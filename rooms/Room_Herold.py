...
class MyRoom(EscapeRoom):
    def __init__(self):
        super().__init__()
        self.set_metadata("Rainer", __name__)
    ...
    def create_level1(self):
        ...
        task_messages = [
            "Du wachst in einem Raum auf und siehst einen Laptop. Du setzt dich auf den Stuhl und schaust auf den Display."
        ...
        hints = [
            "Es gibt verschiedene Module um Webrequests zu nutzen.",
    ...
    def create_level1(self):
        ...
        hints = [
            "Es gibt ein bestimmtes Modul in Python, mit dem man auf Betriebssystemebene arbeiten kann.",
